...
@section('title', 'Tambah Mata Kuliah - SIAKAD Mini')
...
<div class="max-w-3xl mx-auto space-y-6">
    <div class="bg-white p-6 rounded-xl shadow-sm border border-gray-100 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
            ...
            <h1 class="text-2xl font-bold text-gray-900 tracking-tight">Tambah Mata Kuliah Baru</h1>
            <p class="text-sm text-gray-500 mt-0.5">Isi formulir di bawah ini dengan lengkap untuk mendaftarkan mata kuliah baru ke dalam sistem.</p>
        </div>
    </div>
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6 sm:p-8">
        ...
        <form action="{{ route('matakuliah.store') }}" method="POST" class="space-y-6">
            ...
            <div class="flex items-center justify-end gap-3 pt-4 border-t border-gray-100">
                ...
                <button type="submit" 
                    class="bg-blue-600 hover:bg-blue-700 text-white text-sm font-medium px-5 py-2.5 rounded-lg transition shadow-sm">
                    Simpan Data
                </button>
            </div>
        </form>
